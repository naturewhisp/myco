...
| **MYCO-SCI-01**| Science | Semantica e target: `suitabilityScore` (0-100) non calibrato | 5 | 1 | **9.0** | **P1** | 2 SP / **S** | v1.3 | **COMPLETATO** (v1.3.0) |
| **MYCO-SCI-02**| Science | Risoluzione CTMI e famiglie termiche cardinali continue senza fallback | 5 | 2 | **8.0** | **P1** | 3 SP / **S** | v1.3 | **COMPLETATO** (v1.3.0) |
| **MYCO-SCI-03**| Science | Rimozione reset 70%, conservazione massa piogge e fasi continue | 5 | 3 | **7.0** | **P1** | 5 SP / **M** | v1.3 | **COMPLETATO** (v1.3.0) |
| **MYCO-SCI-05**| Data/Time | Date `LocalDate`, fusi sito, pioggia vs neve, missingness tipizzata | 5 | 2 | **8.0** | **P1** | 3 SP / **S** | v1.3 | **COMPLETATO** (v1.3.0) |
| **MYCO-SCI-04**| Multiplatform| Unificazione motore deterministico KMP in `:core` (Android & iOS) | 5 | 4 | **6.0** | **P1** | 8 SP / **M** | v1.3 | **COMPLETATO** (v1.3.0) |
| **MYCO-SCI-08**| Cartography| Parità Heatmap/Scheda puntuale (azzeramento a W=0 o isolamento) | 4 | 2 | **6.0** | **P1** | 3 SP / **S** | v1.3 | **COMPLETATO** (v1.3.3) |
...
| **MYCO-SCI-09**| Quality | Test suite REG-01..20, bonifica date Mindino e test continuità end-to-end | 5 | 2 | **8.0** | **P1** | 5 SP / **M** | v1.3 | **COMPLETATO** (v1.3.3 / REG-01..20 attivi) |
...
| **Blocco 4** | v1.3.3 | **Parità Cross-Platform Android/iOS/Core e Validazione Empirica**: Unificazione matematica tra Android, iOS e core KMP; allineamento Heatmap alla formula puntuale; segregazione test sintetici vs benchmark osservazionali storici e coerenza della modalità WEATHER_ONLY. | F11, F12, F13, F19 | REG-09, REG-10, REG-12, REG-14, REG-18, REG-19 | **Completato** |
...
| **F11** | Heatmap incoerente con il punteggio puntuale | Allineamento equazione di rasterizzazione alla formula unificata (`calculateSuitabilityScore`), azzeramento a W = 0 | `reg09_reg12_heatmapPunctualParityAndZeroWeatherSuppression` | Blocco 4 |
| **F12** | Divergenza tra motore Android e motore iOS | Porting KMP in `:core` condiviso e parità 100% testata (soglie idriche, Hurdle, suitability) | `reg18_crossPlatformParityBetweenAndroidAndCore` | Blocco 4 |
| **F13** | Modalità WEATHER_ONLY disallineata tra scheda e outlook | Propagazione uniforme di WEATHER_ONLY in tutti i calcoli dell'outlook a 7 giorni ($H=A=S=T=1.0$) | `reg10_reg14_weatherOnlyModeCoherenceBetweenCardAndOutlook`, `PhenologicalInvariantsTest` | Blocco 4 |
...
| **F19** | Test sintetici presentati come validazione empirica | Separazione rigorosa tra test di invarianti matematiche e benchmark storici su calendario gregoriano reale (Mindino 25 ago - 26 set 2026, zero date fittizie) | `reg19_mindinoRealCalendarDatesAndLiebigGating`, `benchmark03_mindinoProjectedWeekendPeakSep26` | Blocco 4 |
